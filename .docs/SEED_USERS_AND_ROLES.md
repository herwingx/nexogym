...
| **ADMIN**      | Dueño/gerente del gym          | `/admin`               | Dashboard, Socios, Finanzas, Auditoría, **Personal** (staff: Recepción, Coach, Instructor, **Limpieza**; dar de baja); **Inventario y Cortes** (y Forzar Cierre) solo si el plan tiene POS; **Clases y Rutinas** solo si el plan tiene Clases. |
